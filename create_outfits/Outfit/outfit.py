...
def get_outfit(db, outfit = list(), categories = [], bp_needed = [], undesired = list()) :
	...
	:return:
	"""
	[db, outfit, categories, bp_needed] = checkout_fit_conflict(db, outfit, categories, bp_needed, undesired)
...
def checkout_fit_conflict(db, outfit, categories, bodyPartsNeeded, undesired) :
	"""
